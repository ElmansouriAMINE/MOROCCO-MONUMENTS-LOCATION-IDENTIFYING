...
public class DeleteZoneFragment extends DialogFragment {

    private String message;
    private int id;
    private DeleteZoneInterface deleteInterface;

    public DeleteZoneFragment(String message, int id, DeleteZoneInterface deleteInterface) {
